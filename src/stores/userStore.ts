...
// console.log("process.env.VITE_USER_POOL_ID:", import.meta.env.VITE_USER_POOL_ID);
// console.log("import.meta.env.VITE_USER_POOL_CLIENT_ID:", import.meta.env.VITE_USER_POOL_CLIENT_ID);
